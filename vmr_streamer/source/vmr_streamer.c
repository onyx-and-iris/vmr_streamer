...
long InitResources(LPT_APP_CONTEXT lpapp)
{
	...
	CreateColorPenBrush(&(lpapp->gdiobjects_bkg), RGB(241, 230, 218));
	CreateColorPenBrush(&(lpapp->gdiobjects_bkg_ctl), RGB(235, 216, 198));
	CreateColorPenBrush(&(lpapp->gdiobjects_blue0), RGB(0, 77, 0));
	CreateColorPenBrush(&(lpapp->gdiobjects_blue1), RGB(95,120,137));
	CreateColorPenBrush(&(lpapp->gdiobjects_blue2), RGB(0, 128, 0));
	CreateColorPenBrush(&(lpapp->gdiobjects_blue3), RGB(115, 77, 38));
	CreateColorPenBrush(&(lpapp->gdiobjects_buttongreen), RGB(36,167,49));
	CreateColorPenBrush(&(lpapp->gdiobjects_slidergreen), RGB(77, 153, 0));
	CreateColorPenBrush(&(lpapp->gdiobjects_sliderred), RGB(179, 45, 0));
	CreateColorPenBrush(&(lpapp->gdiobjects_white), RGB(0, 77, 0));

	CreateColorPenBrush(&(lpapp->gdiobjects_meter_blue), RGB(77, 153, 0));
	CreateColorPenBrush(&(lpapp->gdiobjects_meter_green), RGB(26, 255, 163));
	CreateColorPenBrush(&(lpapp->gdiobjects_meter_red), RGB(179, 45, 0));

	CreateColorPenBrush(&(lpapp->gdiobjects_mute), RGB(246,91,81));
	CreateColorPenBrush(&(lpapp->gdiobjects_monitor), RGB(77, 153, 0));
